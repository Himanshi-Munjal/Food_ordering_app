...
mixin _$ItemAttribute {
  String? get vegClassifier => throw _privateConstructorUsedError;
...
abstract class $ItemAttributeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? vegClassifier, String? portionSize});
}
...
class _$ItemAttributeCopyWithImpl<$Res, $Val extends ItemAttribute>
  ...
  @override
  $Res call({
    Object? vegClassifier = freezed,
    Object? portionSize = freezed,
  }) {
    return _then(_value.copyWith(
      vegClassifier: freezed == vegClassifier
          ? _value.vegClassifier
          : vegClassifier // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ItemAttributeImpl implements _ItemAttribute {
  const _$ItemAttributeImpl({this.vegClassifier, this.portionSize});

  factory _$ItemAttributeImpl.fromJson(Map<String, dynamic> json) =>
      _$$ItemAttributeImplFromJson(json);

  @override
  final String? vegClassifier;
  @override
  final String? portionSize;

  @override
  String toString() {
    return 'ItemAttribute(vegClassifier: $vegClassifier, portionSize: $portionSize)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.vegClassifier, vegClassifier) ||
                other.vegClassifier == vegClassifier) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, vegClassifier, portionSize);
